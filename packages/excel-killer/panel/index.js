        ...
        window.plugin = new window.Vue({
            ...
            methods: {
                ...
                _initCfgSavePath() {
                    ...
                    // 自定义json导出路径
                    let jsP1 = path.join(projectPath, "assets");
                    let jsP2 = path.join(jsP1, "resources");
                    let jsP3 = path.join(jsP2, "json");

                    this.jsonSavePath = jsP3;
