 ...
 */
@ccclass
export default class PveResult extends GameView {
    ...
    initView () {
        ...
        if (this.isWin) {
            if (this.normal) {
                ...
                if (parseInt(waveId) == parseInt(data.waveId)) {
                    ...
                    EventDispatcher.dispatchEvent(Events.game_logic_event, {
                        type: COMMONLOGICTYPE.diff,
                        value: parseInt(d.id.toString()),
        ...
        EventDispatcher.dispatchEvent(Events.game_logic_event, {
            type: COMMONLOGICTYPE.wave,
            value: DS(this.fm.curWave),
        })
        ...
        let mapData: MAPDATA = StaticManager.getStaticValue("static_map_data", mapId)
